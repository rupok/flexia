...
<p class="has-text-align-center has-primary-color has-body-color has-link-color has-small-font-size" style="letter-spacing:4px;text-transform:uppercase"><?php echo esc_html_x( 'pricing', 'Message to convey pricing content', 'flexia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","style":{"typography":{"textTransform":"capitalize"}},"textColor":"heading-text","fontSize":"large-plus"} -->
<h2 class="wp-block-heading has-text-align-center has-heading-color has-body-color has-large-plus-font-size" style="text-transform:capitalize"><?php echo esc_html_x( 'Flexible Pricing Plan', 'Message to convey pricing content', 'flexia' ); ?></h2>
<!-- /wp:heading -->
...
<h4 class="wp-block-heading has-body-white-color has-body-color has-medium-font-size"><?php echo esc_html_x( 'Standard', 'Message to convey pricing content', 'flexia' ); ?></h4>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-body-white-color has-body-color has-large-font-size"><?php echo esc_html_x( '$49', 'Message to convey pricing content', 'flexia' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"body-white","fontSize":"small"} -->
<p class="has-body-white-color has-body-color has-small-font-size"><?php echo esc_html_x( '/month', 'Message to convey pricing content', 'flexia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"textColor":"body-alt","fontSize":"small"} -->
<p class="has-body-alt-color has-body-color has-small-font-size"><?php echo esc_html_x( 'Get started with basic features and kickstart your journey', 'Message to convey pricing content', 'flexia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-body-white-color has-heading-background-color has-body-color has-background has-link-color wp-element-button"><?php esc_html_e( 'Get Started', 'flexia' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<h4 class="wp-block-heading has-body-white-color has-body-color has-medium-font-size"><?php echo esc_html_x( 'Premium', 'Message to convey pricing content', 'flexia' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|xx-small","margin":{"bottom":"var:preset|spacing|xx-small"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--xx-small)"><!-- wp:heading {"textColor":"body-white","fontSize":"large"} -->
<h2 class="wp-block-heading has-body-white-color has-body-color has-large-font-size"><?php echo esc_html_x( '$149', 'Message to convey pricing content', 'flexia' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-black-color has-body-color has-small-font-size" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><?php echo esc_html_x( 'Popular', 'Message to convey pricing content', 'flexia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
...
<!-- wp:paragraph {"textColor":"body-white","fontSize":"small"} -->
<p class="has-body-white-color has-body-color has-small-font-size"><?php echo esc_html_x( 'Unlock advanced tools for greater results & elevate experience', 'Message to convey pricing content', 'flexia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->
...
<h4 class="wp-block-heading has-body-white-color has-body-color has-medium-font-size"><?php echo esc_html_x( 'Enterprise', 'Message to convey pricing content', 'flexia' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|xx-small","margin":{"bottom":"var:preset|spacing|xx-small"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--xx-small)"><!-- wp:heading {"textColor":"body-white","fontSize":"large"} -->
<h2 class="wp-block-heading has-body-white-color has-body-color has-large-font-size"><?php echo esc_html_x( '$200', 'Message to convey pricing content', 'flexia' ); ?></h2>
<!-- /wp:heading -->
