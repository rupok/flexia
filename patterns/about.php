...
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|40","right":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"layout":{"type":"constrained"}} -->
<div id="about" class="wp-block-group" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)"><!-- wp:columns {"verticalAlignment":"center","align":"wide"} -->
...
<p class="has-text-align-left has-primary-color has-body-color has-link-color has-small-font-size" style="letter-spacing:4px;text-transform:uppercase"><?php echo esc_html_x( 'About us', 'Message to convey that about page', 'flexia' ); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image alignright size-thumbnail is-resized has-custom-border ml-40 mb-60"><img src="<?php echo esc_url( get_theme_file_uri( "/assets/images/about/about-img-1.jpg" ) ); ?>" alt="" style="border-radius:5px;width:150px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->

<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:cover {"url":<?php echo wp_json_encode( get_theme_file_uri( "/assets/images/about/about-img-2.jpg" ), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT ); ?>,"dimRatio":0,"minHeight":600,"minHeightUnit":"px","isDark":false,"style":{"color":[]}} -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri( "/assets/images/about/about-img-3.jpg" ) ); ?>" alt=""/></figure>
<!-- /wp:image -->

<!-- wp:image {"sizeSlug":"full","style":{"color":[]}} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri( "/assets/images/about/about-img-4.jpg" ) ); ?>" alt=""/></figure>
<!-- /wp:image -->

<!-- wp:image {"align":"right","width":"280px","style":{"border":{"radius":"0px"}}} -->
<figure class="wp-block-image alignright is-resized has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( "/assets/images/about/about-img-5.jpg" ) ); ?>" alt="" style="border-radius:0px;width:280px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
