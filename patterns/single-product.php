        ...
        <div class="wp-block-group alignwide">
            ...
            <div class="wp-block-columns alignwide">
                ...
                <div class="wp-block-column" style="flex-basis:50%">
                    ...
                    <!-- wp:woocommerce/product-rating {"isDescendentOfSingleProductTemplate":true,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|20"}}}} /-->

                    <!-- wp:woocommerce/product-price {"isDescendentOfSingleProductTemplate":true,"fontSize":"medium-plus","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}}} /-->

                    <!-- wp:post-excerpt {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}}} /-->

                    <!-- wp:woocommerce/add-to-cart-form /-->

                    <!-- wp:woocommerce/product-meta {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30"}}}} /-->
            ...
            <h2 class="wp-block-heading has-text-align-center has-large-font-size"><?php esc_html_e( 'Related Products', 'flexia' ); ?></h2>
            <!-- /wp:heading -->

            <!-- wp:woocommerce/product-collection {"queryId":2,"query":{"perPage":4,"pages":0,"offset":0,"postType":"product","order":"desc","orderBy":"date","search":"","exclude":[],"inherit":false,"taxQuery":{},"isProductCollectionBlock":true,"featured":false,"woocommerceOnSale":false,"woocommerceStockStatus":["instock","outofstock","onbackorder"],"woocommerceAttributes":[],"woocommerceHandPickedProducts":[],"filterable":false,"relatedBy":{"categories":true,"tags":true}},"tagName":"div","displayLayout":{"type":"flex","columns":4},"collection":"woocommerce/product-collection/related","queryContextIncludes":["collection"],"hideControls":["inherit"],"align":"wide"} -->
            <div class="wp-block-woocommerce-product-collection alignwide">
                ...
                <div class="wp-block-group">
                    ...
                    <p class="has-text-align-center"><?php esc_html_e( 'No related products found.', 'flexia' ); ?></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
                <!-- /wp:woocommerce/product-collection-no-results -->
