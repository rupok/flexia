...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"0","right":"0","left":"var:preset|spacing|50"}},"border":{"radius":"8px"}},"gradient":"vibrant","layout":{"type":"flex","flexWrap":"wrap"}} -->
<div class="wp-block-group alignwide has-vibrant-gradient-background has-background" style="border-radius:8px;padding-top:0;padding-right:0;padding-left:var(--wp--preset--spacing--50)"><!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"padding":{"right":"0","left":"0"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:image {"sizeSlug":"full","linkDestination":"none","className":"margin\u002d\u002dleft-130"} -->
<figure class="wp-block-image size-full margin--left-130"><img src="<?php echo esc_url( get_theme_file_uri("/assets/images/cta-bg.png") ); ?>" alt="" class=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
