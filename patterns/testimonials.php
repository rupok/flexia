...
<div class="wp-block-group"><!-- wp:heading {"style":{"typography":{"textTransform":"capitalize"}},"textColor":"dark-background","fontSize":"medium"} -->
<h2 class="wp-block-heading has-dark-background-color has-text-color has-medium-font-size" style="text-transform:capitalize">John Smith</h2>
<!-- /wp:heading -->
