...
<figure class="wp-block-image size-full is-resized"><img src="http://flexia-final.local/wp-content/themes/flexia/assets/images/mail-open-line.png" alt="" class="wp-image-9" style="object-fit:contain;width:18px;height:20px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full is-resized"><img src="http://flexia-final.local/wp-content/themes/flexia/assets/images/user-line.png" alt="" class="wp-image-15" style="object-fit:contain;width:18px;height:20px"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group alignwide"><!-- wp:site-logo {"width":200,"shouldSyncIcon":true,"style":{"color":{"duotone":"var:preset|duotone|midnight-blue"}}} /-->
