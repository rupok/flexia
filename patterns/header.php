...
<div class="wp-block-group alignwide"><!-- wp:image {"width":"140px","height":"35px","scale":"contain","style":{"color":{"duotone":"var:preset|duotone|midnight-blue"}},"className":"size-full"} -->
<figure class="wp-block-image is-resized size-full"><a href="<?php echo esc_url( get_home_url() ); ?>">
<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/logo.png" alt="Home" style="object-fit:contain;width:140px;height:35px;filter: unset !important;"/></a></figure>
<!-- /wp:image -->
