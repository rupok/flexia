...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri( "/assets/images/mail-open-line.png" ) ); ?>" alt="" class="" style="object-fit:contain;width:18px;height:20px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri( "/assets/images/user-line.png" ) ); ?>" alt="" class="" style="object-fit:contain;width:18px;height:20px"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group alignwide"><!-- wp:image {"width":"180px","style":{"color":{"duotone":"var:preset|duotone|midnight-blue"}},"className":"size-full"} -->
<figure class="wp-block-image size-full"><a style="width:180px;"href="<?php echo esc_url( get_home_url() ); ?>"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/logo.svg" alt="Home"/></a>
</figure>
<!-- /wp:image -->

<!-- wp:navigation {"ref":48,"textColor":"Heading","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"right"},"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"fontSize":"medium"} /-->
