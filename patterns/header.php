...
<figure class="wp-block-image size-full"><a href="<?php echo esc_url( get_home_url() ); ?>"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/logo.svg" alt="Home"/></a>
</figure>
<!-- /wp:image -->
