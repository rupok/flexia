...
<div class="wp-block-group"><!-- wp:cover {"url":"http://flexia-final.local/wp-content/themes/flexia/assets/images/banner-bg-1.png","id":181,"dimRatio":0,"overlayColor":"secondary","contentPosition":"center center","isDark":false,"align":"wide","style":{"spacing":{"padding":{"right":"0px","left":"0px","top":"110px","bottom":"110px"}},"border":{"radius":"8px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignwide is-light" style="border-radius:8px;padding-top:110px;padding-right:0px;padding-bottom:110px;padding-left:0px"><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-181" alt="" src="http://flexia-final.local/wp-content/themes/flexia/assets/images/banner-bg-1.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"center","align":"wide"} -->
<div class="wp-block-columns alignwide are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:heading {"fontSize":"huge"} -->
<h2 class="wp-block-heading has-huge-font-size">Creative solutions to improve your business</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"style":{"elements":{"link":{"color":{"text":"var:preset|color|dark-background"}}}},"textColor":"text","fontSize":"small"} -->
<h2 class="wp-block-heading has-text-color has-link-color has-small-font-size"><a href="#">Book A Call</a></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
