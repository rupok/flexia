...
<figure class="wp-block-image size-full is-resized"><img src="http://flexia-final.local/wp-content/uploads/2023/11/cImage.png" alt="" class="wp-image-1317" style="object-fit:cover;width:84px;height:auto"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full margin--left"><img src="http://flexia-final.local/wp-content/uploads/2023/11/image-1.png" alt="" class="wp-image-1082"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->