...
<div class="wp-block-group" style="padding-right:0;padding-left:0"><!-- wp:image {"id":1317,"width":"54px","height":"auto","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri( "/assets/images/stack-img.png" ) ); ?>" alt="" class="wp-image-1317" style="object-fit:cover;width:54px;height:auto"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
