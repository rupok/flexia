...
<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"0","bottom":"var:preset|spacing|50"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:image {"sizeSlug":"full","linkDestination":"none"} -->
...
<h1 class="wp-block-heading has-text-align-center has-huge-font-size" style="line-height:1.4;text-transform:capitalize"><?php echo esc_html_x( 'Page Not Found', 'Message to error page', 'flexia' ); ?></h1>
<!-- /wp:heading -->
...
<div class="wp-block-button aligncenter"><a class="wp-block-button__link wp-element-button" href="/"><?php echo esc_html_x( 'Go Home', 'Message to error page', 'flexia' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></main>
<!-- /wp:group -->
