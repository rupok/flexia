...
<!-- wp:post-excerpt {"moreText":<?php echo wp_json_encode( _x( 'Read More', 'Read More button text', 'flexia' ), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT ); ?>,"excerptLength":30} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
<!-- /wp:post-template -->
