...
function flexia_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'flexia' ),
		'id'            => 'sidebar-1',
...
function flexia_scripts() {
	...
	wp_enqueue_script( 'flexia-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'flexia-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
