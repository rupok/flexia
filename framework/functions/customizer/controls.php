...
?>
		<label>
			<?php if (!empty($this->label)) : ?>
				...
				<a href="#" title="<?php echo esc_html('Reset', 'flexia') ?>" class="flexia-customizer-reset <?php echo esc_html($this->type); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="20px">
	...
	?>
		<label>
			<div style="display:flex;flex-direction: row;justify-content: flex-start;">
				...
				<input id="cb<?php echo wp_kses_post($this->instance_number) ?>" type="checkbox" class="tgl tgl-<?php echo esc_attr($this->type) ?>" value="<?php echo esc_attr($this->value()); ?>" <?php $this->link();
																																																		checked($this->value()); ?> />
