...
<section class="no-results not-found">
	...
	<div class="page-content">
			...
			<p><?php
				printf(
					wp_kses(
						...
						__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'flexia' ),
						array(
							'a' => array(
								'href' => array(),
							),
		...
		<?php elseif ( is_search() ) : ?>
			...
			<h1 class="page-title"><?php esc_html_e( 'Nothing Found!', 'flexia' ); ?></h1>
			<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'flexia' ); ?></p>
			<?php
				get_search_form();

		else : ?>

			<p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'flexia' ); ?></p>
			<?php
				get_search_form();
